...
public class RandomVerificationCode {
    ...
    private static String randomNumber = "0123456789";// 随机产生的验证码
    ...
    public static String getRandomNumber(int n){
        ...
        for (int i = 0;i < n;i++){
            builder.append(randomNumber.charAt(random.nextInt(randomNumber.length())));
        }
